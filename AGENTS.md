...
Personal workspace following _Hands-on Machine Learning with C++ (2nd ed.)_, plus _Learning Modern C++ for Finance_.

don't make changes to `Hands-on-Machine-learning-with-C-Second-Edition` and `LearningModCppFinance`
